...
public class DBHelper {
	...
	public Connection openConnection() {
		String url = "jdbc:mysql://112.74.84.42/Test"; // 数据库的地址
	...
	public static void main(String[] args) {
		...
		List<Map<String, Object>>list =dbhelper.query("select * from login");
		...
		// deptno=60");
		/*
		 * System.out.println("========================="); List<Map<String, Object>>
		 * list = dbhelper.query("select * from emp"); for (Map<String, Object> map :
		 * list) { System.out.println(map); }
		 * 
		 * System.out.println("========================="); list =
		 * dbhelper.query("select * from emp where ename like ?", "%S%"); for
		 * (Map<String, Object> map : list) { System.out.println(map); }
		 * 
		 * System.out.println("========================="); list =
		 * dbhelper.query("select * from emp where ename like ? " + " and sal > ? ",
		 * "%S%", 1250); for (Map<String, Object> map : list) { System.out.println(map);
		 * }
		 * 
		 * System.out.println("==========1====5==========="); list =
		 * dbhelper.queryPage("select * from emp", 1, 5); for (Map<String, Object> map :
		 * list) { System.out.println(map); }
		 * 
		 * System.out.println("==========2====5==========="); list =
		 * dbhelper.queryPage("select * from emp", 2, 5); for (Map<String, Object> map :
		 * list) { System.out.println(map); }
		 * 
		 * System.out.println("==========3====5==========="); list =
		 * dbhelper.queryPage("select * from emp", 3, 5); for (Map<String, Object> map :
		 * list) { System.out.println(map); }
		 * 
		 * System.out.println("==========1====5====7521======="); list =
		 * dbhelper.queryPage("select * from emp where empno > ? ", 1, 5, 7521); for
		 * (Map<String, Object> map : list) { System.out.println(map); }
		 */
	}
